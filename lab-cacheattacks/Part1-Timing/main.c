...
int main (int ac, char **av) {
    ...
    // This buffer is the size of 48 KB, which is enough to evict L1 1.5 times. 
    ...
    // This buffer is the size of 1.5 MB, which is enough to evict L2 1.5 times. 
